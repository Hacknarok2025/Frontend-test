            ...
            <div className="relative z-10 h-screen w-[90%] mx-auto py-20 flex flex-col">
                ...
                <div className="self-end relative right-20 flex gap-4">
                    <Button
                        ...
                        add="px-18 text-white border-5 border-solid border-black hover:border-white   transition duration-300"
                        size="6xl"
                    >
                        Continue Game
                    </Button>
                    <Button
                        onClick={() => setModalOpen(true)}
                        add="px-18 text-black border-5 border-solid border-white bg-white hover:border-black  hover:bg-white transition duration-300"
                        size="6xl"
                    >
                        Start Game
                    </Button>
