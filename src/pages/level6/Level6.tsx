...
const Level6 = () => {
  ...
  const checkForWin = () => {
    ...
    if (allMatched) {
      const gameScore = Math.max(100 - moves * 5 - gamesPlayed * 10, 0);
      setScore(gameScore);
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          transition={{ delay: 0.5, duration: 0.8 }}
        >
          <h1 className="text-8xl font-bold mb-10 text-white drop-shadow-lg">
            Memory Game
          </h1>

          <div className="flex gap-10 mb-10">
            <h2 className="text-5xl text-white drop-shadow-lg">
              Ruchy: {moves}
            </h2>
            <h2 className="text-5xl text-white drop-shadow-lg">
              Gry: {gamesPlayed}
          ...
          <div className="mt-10 flex gap-4 justify-end">
            <Button
              ...
              add={
                'px-24 py-6 text-5xl hover:bg-white hover:text-black skew-x-[24deg] border-2 border-solid border-black text-white'
              }
            >
              Nowa gra
            </Button>
      ...
      <Modal3 open={isModalOpen3} onClose={() => setModalOpen3(false)}>
        ...
        <p className="text-3xl mb-3  font-bold">Games:{gamesPlayed}</p>
      </Modal3>
    </AnimatePresence>
  );
};
